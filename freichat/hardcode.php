...
/* Data base details */
$dsn='mysql:host=localhost;dbname=sanhsmis'; //DSN
$db_user='root'; //DB username 
$db_pass='03231979'; //DB password 
$driver='Custom'; //Integration driver
$db_prefix=''; //prefix used for tables in database
$uid='593aa58ccc1a2'; //Any random unique number
...
$admin_pswd='03231979'; //backend password 
...
$row_username='user_fullname'; //specifies the name of the field in which the user's name/display name is stored.
$row_userid='user_no'; //specifies the name of the field in which the user's id is stored (usually id or userid)


$avatar_table_name='users'; //specifies the table where avatar information is stored
