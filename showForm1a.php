		...
		<td align="center" valign="top">
			...
			<table width="100%" border="0">
				<tr height="25">
					...
					<td align="center" colspan="2" style="BORDER-RIGHT: black solid 1px; BORDER-TOP: black solid 1px; BORDER-LEFT: black solid 1px; BORDER-BOTTOM: black solid 1px"><font size="1">Sagbayan</td>
					<td></td>
				</tr>
				<tr height="25">
...
<table border="1" cellspacing="0" cellpadding="1" width="1135">
	<tr>
		...
		<th rowspan="2">Sex</th>
		<th rowspan="2" width="3%">First Day</th>
		<th rowspan="2">CCT</th>
	...
	<tr height="25">
		...
		$checkFD = dbquery("SELECT * FROM school_days WHERE (sch_sy='".$current_sy."' AND sch_stud_no='".$data['stud_no']."')");
		$dataFD = dbarray($checkFD);
		?>
															
		<td><?php echo $dataFD['sch_firstday'];?></td>
		<?php
		...
		<td><?php echo strtoupper($data['studCont_stud_flname'].", ".$data['studCont_stud_ffname']." ".$data['studCont_stud_fmname']);?></td>
		<td><?php echo strtoupper($data['studCont_stud_mlname'].", ".$data['studCont_stud_mfname']." ".$data['studCont_stud_mmname']);?></td>
		<td><?php echo strtoupper($data['studCont_stud_glname'].", ".$data['studCont_stud_gfname']." ".$data['studCont_stud_gmname']);?></td>
		<td><?php echo strtoupper($data['studCont_stud_grelation']);?></td>
		<td><?php echo strtoupper($data['studCont_stud_gcontact']);?></td>
		<td><?php echo ($data['enrol_status1']=="ENROLLED")?"":$data['enrol_remarks'];?><?php echo (substr($data['enrol_remarks'],0,2))=="LE"?$data['enrol_remarks']:"";?></td>
	</tr>
	<?php 
	...
	<tr>
		...
		<table border="1" cellspacing="0" cellpadding="1" width="1135">
			...
			<tr height="25">
				...
				?>
				<td align="center" valign="bottom" style="BORDER-RIGHT: black solid 0px; BORDER-TOP: black solid 0px; BORDER-LEFT: black solid 0px; BORDER-BOTTOM: black solid 0px"><u><strong><?php echo $dataAdviser['user_fullname']; ?></strong></u></td>
				<td style="BORDER-RIGHT: black solid 0px; BORDER-TOP: black solid 0px; BORDER-LEFT: black solid 0px; BORDER-BOTTOM: black solid 0px"></td>
				<td align="center" valign="bottom" style="BORDER-RIGHT: black solid 0px; BORDER-TOP: black solid 0px; BORDER-LEFT: black solid 0px; BORDER-BOTTOM: black solid 0px"><u><strong><?php echo $current_principal; ?></strong></u></td>
			</tr>
			<tr>
				<td>Dropped</td>
		...
		<table>
			<tr>
				...
				<td>_____________________________<br>Generated thru LIS</td>
			</tr>
		</table>