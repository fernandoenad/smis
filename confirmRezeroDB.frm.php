...
<div class="modal-content">
    <div class="modal-header">
		...
		<h4 class="modal-title">Confirm Rezer0</h4>
    </div>
	...
	<div class="modal-footer">
		<a href="rezerodb.src.php" id="submit" name="submit" class="btn btn-primary" disabled="disabled" onclick="return confirm('Are you sure you want to re-zero the database? This action will erase all your data...')">Proceed</a>
