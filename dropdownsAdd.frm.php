...
if(isset($_GET['Save']) && $_GET['Save']="Yes"){
	$updateClass = dbquery("insert into dropdowns (field_no, field_category, field_name, field_ext) values ('','".$_POST['field_category']."','".$_POST['field_name']."','".$_POST['field_ext']."')");
...
<!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Dropdown Item List for Category <?php echo $_GET['category'];?> </h4>
      </div>
	  <form name="form1" method="post" action="dropdownsAdd.frm.php?Save=Yes">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<div class="form-group">
							...
							<input type="text" id="field_ext" name="field_ext" maxlength="200" required="required" class="form-control" value="-">
