...
;(function ($, window, undefined) {
	...
	function Plugin (el, options) {
		...
		base.bind = function(){
			...
			base.$window.on('scroll.' + name, base.updateWidth);
		...
		base.toggleHeaders = function () {
			base.$el.each(function () {
				 ...
				 * Edited may 7, 13
				 * @author Kevin F
				 * New offset depends on navbar visibility
				 * if navbar is affix offset is equal to navheight else
				 * offset is 0;
				 */
				var navOffset = $("header .navbar").position()['top'];
				var	newTopOffset = navOffset > 0 ? $("header .navbar").height()-2 : 0 ;
				...
				if ((scrollTop > offset.top) && (scrollTop < offset.top + $this.height() - base.$clonedHeader.height())) {
					...
					base.$clonedHeader.css({
						...
						'margin-top': 0,
						'left': newLeft,
						'box-shadow': '0px 3px 13px rgba(0, 0, 0, 0.0980392)'
					});
					base.$clonedHeader.stop(true, true).slideDown(200);
					...
					base.$clonedHeader.stop(true, true).fadeOut(50);
					base.$originalHeader.css('visibility', 'visible');
					base.isCloneVisible = false;
				}
			});
