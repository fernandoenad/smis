										...
										<div class="panel panel-default">
											<div class="panel-heading">
											    <div class="btn-toolbar  pull-right">
													<div class="btn-group">
													<a onclick="window.open('<?php echo ($current_school_code=="302887" && (strtotime($_GET['year']."-".$_GET['month']."-01")>=strtotime("2019-09-01"))?"showDTR1":"showDTR");?>.php?teach_no=<?php echo $data['teach_no'];?>&year=<?php echo $_GET['year'];?>&month=<?php echo $_GET['month'];?>', 'newwindow', 'width=850, height=600'); return false;" <?php echo ($_GET['showDTR']==0?"disabled":"");?> title="Print DTR" class="btn  btn-xs  btn-default">
												...
												<table class="table table-bordered table-condensed table-striped table-sticky" style="margin-bottom:20px !important">
													...
													?>
														<tr>
															...
															?>
																<a href="missinglogs.scr.php?ml_no=<?php echo $dataCurrentLogs['checkinout_no'];?>&changeState=Yes&state=<?php echo $stateChange;?>&userid=<?php echo $dataCurrentLogs['USERID'];?>&checktime=<?php echo $dataCurrentLogs['CHECKTIME'];?>&checktype=<?php echo $dataCurrentLogs['CHECKTYPE'];?>" title="Change State"  onClick="return confirm('Are you sure you want to change the <?php echo $stateCurrent;?> state to the <?php echo $stateChange;?> state?')">
															...
															$dataMissingLog = (isset($dataMissingLog) ? $dataMissingLog : array("ml_approve_user_no"=>0));
