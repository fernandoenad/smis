...
$teacherDetails = dbquery("select * from missinglogs inner join teacher on ml_userid=teach_bio_no where ml_approve_user_no='0' order by ml_userid desc, teach_fname asc , ml_checkdate asc, ml_checktime asc limit 50");
?>
<div class="modal-content">
    <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">&times;</button>
		<h4 class="modal-title">Mass Disapproval Panel</h4>
    </div>
	<form method="post" action="missinglogs.scr.php?MassDisapprove=Yes">
					...
					<div class="form-group">
						<table class="table-hover" width="100%" border="1" cellspacing="0" cellpadding="1">
							<tr>
								...
								<th width="15%" align="center">Disapprove?</th>
							</tr>	
						<?php
