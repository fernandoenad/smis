...
<table border="1" cellspacing="0" cellpadding="1" width="800">
	...
	<tr>
		...
		$resultGrade1 = dbquery("SELECT * FROM grade INNER JOIN class ON grade.grade_class_no=class.class_no INNER JOIN prospectus ON class.class_pros_no=prospectus.pros_no WHERE (grade.grade_stud_no='".$data['stud_no']."' AND class.class_sy='".$data['enrol_sy']."' and class_sem='".$active_sem."') ORDER BY class_sem ASC, pros_sort ASC, pros_title asc");
		...
		?>
		<td align="center" bgcolor="yellow"><b><?php echo ($countUnits!=$gradedUnits1?"":number_format($aveQ1/$countUnits,3));?></b></td>
