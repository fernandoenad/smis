...
<tr>
	<td width="50%" align="center">
		<table border="0" cellspacing="0" cellpadding="1" width="90%">
			...
			<?php
			$checkTeacherData = dbquery("SELECT * FROM teacherappointments INNER JOIN dropdowns ON teacherappointments_position=field_name WHERE teacherappointments_teach_no='".$dataTeacher['teach_no']."'");
			$dataTeacherData = dbarray($checkTeacherData);
