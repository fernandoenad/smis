...
<head>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="780">	
		...
		?>	
		<tr>
			<td colspan="4"><input type="checkbox" checked style="width: 10px; height: 10px;"> <?php echo (isset($dataGradeSchool['enrol_eligibility']) ? $dataGradeSchool['enrol_eligibility'] : "");?> *</td>
			<td colspan="2" align="right">Gen. Ave. / Rating:  &nbsp; &nbsp;</td>
			<td style="border-bottom: 1px solid; text-align: center"> <strong><?php echo (isset($dataGradeSchool['enrol_average']) ? round($dataGradeSchool['enrol_average'],0) : "");?></strong></td>	
			<td colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date of Graduation/ Completion/ Assessment/ Examination (MM/DD/YYYY):  &nbsp;</td>
			<td colspan="2" style="border-bottom: 1px solid; text-align: center"> <strong><?php $phpdate = (isset($dataGradeSchool['enrol_graddate']) ? strtotime($dataGradeSchool['enrol_graddate']) : strtotime('1970-01-01')); echo $mysqldate = date('m/d/Y', $phpdate);?></strong></td>		
		</tr>	
		<tr>
			<td colspan="6" align="right">Name of School / Testing Center - School ID (Except ALS & PEPT) - Address:  &nbsp; &nbsp;</td>
			<?php
			$dataEnrollmentSchool = (isset($dataGradeSchool['enrol_school']) ? unserialize($dataGradeSchool['enrol_school']) : "");
			?>
			<td colspan="8" style="border-bottom: 1px solid;"> <strong><?php echo (isset($dataEnrollmentSchool['1']) ? strtoupper($dataEnrollmentSchool['1']) : '');?> - <?php echo (isset($dataEnrollmentSchool['0']) ? strtoupper($dataEnrollmentSchool['0']) : '');?> - <?php echo (isset($dataEnrollmentSchool['2']) ? strtoupper($dataEnrollmentSchool['2']) : '');?></strong></td>
		</tr>		
		<tr>
			<td width="7%"></td><td width="5%"></td><td width="7%"></td><td width="6%"></td><td width="9%"></td><td width="7%"></td><td width="5%"></td>
			<td width="5%"></td><td width="7%"></td><td width="7%"></td><td width="7%"></td><td width="7%"></td><td width="7%"></td><td width="10%"></td>
